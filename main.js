...
function checkInputs() {
    // trim убирает белые пробелы
	const name = name.value.trim();
	const surname = surname.value.trim();
	const age = age.value.trim();
	const mark = mark.value.trim();
	const specialization = specialization.value.trim();
    ...
    if(surnameValue === '') {
		setErrorFor(surname, 'surame cannot be blank');
	} else {
    ...
    if(markValue === '') {
		setErrorFor(mark, 'mark cannot be blank');
	} else {
		setSuccessFor(mark);
    }
    if(specialization === '') {
		setErrorFor(specialization, 'specialization cannot be blank');
	} else {
		setSuccessFor(specialization);
	}
}
